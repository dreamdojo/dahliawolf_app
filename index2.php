...
<style>
    ...
    .theBox{width: 500px;height: 485px;border-radius: 3px;position: fixed; top: 41px;left: 60px; z-index: 1;font-size: 13px;color: #C5C9CC;box-shadow: 0 0 3px #1A1A1A; min-height: 300px; min-width:250px;  max-width:450px; overflow: hidden; font:Arial, Helvetica, sans-serif;}
...
<div id="slideshow-frame">
    <div class="slide">
        <video style="min-width: 100%; min-height: 100%;" controls autoplay loop>
