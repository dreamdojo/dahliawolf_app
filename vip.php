...
<style>
    ...
    .bg_image{position: fixed; left: 0px; top: 290px; width: 100%; height: 100%; background-position: 50%; background-repeat: no-repeat;background-size: auto 100%; background-image: url('/images/DW-slide-1.jpg');}
</style>
