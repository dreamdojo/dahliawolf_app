...
<div class="transCol">
    ...
    <a href="/faqs">
        <img src="/public_html/images/hiwClickme.png">
    </a>
    <div class="row1">
        <ul>
            <li><img src="/public_html/images/conMail.png"></li>
        ...
        <ul>
            <li><img src="/public_html/images/conTel.png"></li>
            <li><h3>CALL US TOLL FREE</h3></li>
            <li>1-800-9302 8am -6pm PT</li>
            <li>5 days a week</li>
        </ul>
        <ul>
            <li><img src="/public_html/images/conCom.png"></li>
