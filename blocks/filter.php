<div id="sort-bar">
    <div class="filter-wrap">
        ...
        <span class="">
            <a id="filterNewest" class="sort-option <?= ($_GET['sort'] == 'new' || empty($_GET['sort']) ? 'filter-select' : '') ?>" href="/spine?sort=new">newest</a>
        </span> /
        <span class="">
            <a id="filterTrending" class="sort-option <?= ($_GET['sort'] == 'hot' ? 'filter-select' : '') ?>" href="/spine?sort=hot"> trending</a>
        </span>
        <? if (IS_LOGGED_IN): ?>
             / <span class="">
