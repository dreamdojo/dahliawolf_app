<div id="sort-bar">
    <div class="filter-wrap">
        ...
        <span class=""><a class="sort-option <?= ($_GET['sort'] == 'hot' ? 'filter-select' : '') ?>" href="/spine?sort=hot"> trending</a></span> /
        ...
        <? endif ?>
        <span style="float: right;width: 150px;margin-right: 20px;">view: <span class=""><a class="sort-option <?= ($self == '/spine.php' ? 'filter-select' : '') ?>" href="/spine">artistic</a></span> /
        <span class=""><a class="sort-option <?= ($self == '/grid.php' ? 'filter-select' : '') ?>" href="/grid"> grid</a></span>
        </span>
    </div>
</div>