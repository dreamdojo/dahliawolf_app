...
$params = array(data => file_get_contents($_SERVER['DOCUMENT_ROOT']."/postings/uploads/image.php?imagename=736_1379463313.jpg"), type => "photo", source=>urlencode('http://www.dahliawolf.com/images/logo_no_beta.png') );
