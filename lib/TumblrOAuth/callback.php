...
$params = array("data" => array(file_get_contents($_SERVER['DOCUMENT_ROOT']."/images/logo_no_beta.png"), file_get_contents($_SERVER['DOCUMENT_ROOT']."images/logo_no_beta.png")),
    "type" => "photo", source=>'http://www.dahliawolf.com/images/logo_no_beta.png');
