...
$params = Array(type=>'photo',state=>'published',link=>urlencode('http://www.dahliawolf.com'), source=>urlencode('http://www.dahliawolf.com/postings/uploads/image.php?imagename=1379454763'), data=>file_get_contents('/postings/uploads/image.php?imagename=1379454763'));
