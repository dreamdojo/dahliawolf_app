...
$params = array(data =>  file_get_contents($_SERVER['DOCUMENT_ROOT']."/images/logo_no_beta.png"), type => "photo", source=>urlencode('http://www.dahliawolf.com/images/logo_no_beta.png') );
var_dump($params);
$newPost = $tum_oauth->post('http://api.tumblr.com/v2/blog/monk3ypoop.tumblr.com/post',$params);
echo $_SERVER['DOCUMENT_ROOT']."/images/logo_no_beta.png<br>";
var_dump($newPost);
