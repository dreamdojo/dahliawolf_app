<form id="shippingForm" action="/action/shop/billing.php" class="Form StaticForm billing" method="post">
	...
	<fieldset id="billing-address-fields">
		<ul class="fields">
			<li>
				...
				<input class="isRequired" type="text" id="billing-first-name" name="billing_first_name" />
			</li>
			<li>
				<label for="billing-last-name">Last Name <em>*</em></label>
				<input class="isRequired" type="text" id="billing-last-name" name="billing_last_name" />
			</li>
			<li>
			...
			<li>
				...
				<input class="isRequired" type="text" id="billing-address" name="billing_address" />
			</li>
			<li>
			...
			<li>
				...
				<input class="isRequired" type="text" id="billing-city" name="billing_city" />
			</li>
			<li>
			...
			<li>
				...
				<input class="isRequired" type="text" id="billing-zip" name="billing_zip" />
			</li>
            
            <li>
				<label for="billing-phone">Phone <em>*</em></label>
				<input class="isRequired" type="text" id="billing-phone" name="billing_phone" />
			</li>
			<?
			/*
	...
	<fieldset id="shipping-address-fields"<?= $saved_shipping_selected ? ' style="display:none"' : '' ?>>
		...
		<ul class="fields">
			<li>
				...
				<input class="isAlsoRequired" type="text" id="shipping-first-name" name="shipping_first_name" />
			</li>
			<li>
				<label for="shipping-last-name">Last Name <em>*</em></label>
				<input  class="isAlsoRequired" type="text" id="shipping-last-name" name="shipping_last_name" />
			</li>
			...
			<li>
				...
				<input  class="isAlsoRequired" type="text" id="shipping-address" name="shipping_address" />
			</li>
			<li>
			...
			<li>
				...
				<input  class="isAlsoRequired" type="text" id="shipping-city" name="shipping_city" />
			</li>
			<li>
			...
			<li>
				...
				<input  class="isAlsoRequired" type="text" id="shipping-zip" name="shipping_zip" />
			</li>
            
            <li>
				<label for="shipping-phone">Phone <em>*</em></label>
				<input  class="isAlsoRequired" type="text" id="shipping-phone" name="shipping_phone" />
			</li>
			<?
			/*
			<li>
	...
	<fieldset>
		<input type="submit" value="Next Step &gt" style="float: right;" />
	</fieldset>
</form>